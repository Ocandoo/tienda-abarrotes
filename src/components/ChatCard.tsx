    ...
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      ...
      <div>
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h5 className="font-medium">Darwin Roa</h5>
              <p>
                <span className="text-sm">Voy llegando</span>
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h5 className="font-medium">Roller Paez</h5>
              <p>
                <span className="text-sm">Qué hace?</span>
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h5 className="font-medium">Angel Pro</h5>
              <p>
                <span className="text-sm">Crack maquina!</span>
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-between">
            <div>
              <h5 className="font-medium">Santyago</h5>
              <p>
                <span className="text-sm">Gym o que?</span>
