...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-principal duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex justify-center text-white px-6 py-6 p-5">
        <NavLink to="/">
          <img src={Logo} alt="Logo" />
          <div className='flex justify-center border-solid font-bold'>Tienda Abarrotes</div>
        </NavLink>
